...
from deep_sort_oh.deep_sort import nn_matching
from deep_sort_oh.deep_sort.detection import Detection
from deep_sort_oh.deep_sort.tracker import Tracker
from deep_sort_oh.utils.nms import non_max_suppression
...
class DeepSort(object):
    def __init__(
        ...
        max_iou_distance : Optional[float] = 0.7
            ...
            disregarded. Argument for deep_sort_oh.deep_sort.tracker.Tracker.
        max_age : Optional[int] = 30
            Maximum number of missed misses before a track is deleted. Argument for deep_sort_oh.deep_sort.tracker.Tracker.
        n_init : int
            Number of frames that a track remains in initialization phase. Defaults to 3. Argument for deep_sort_oh.deep_sort.tracker.Tracker.
        ...
        override_track_class : Optional[object] = None
            Giving this will override default Track class, this must inherit Track. Argument for deep_sort_oh.deep_sort.tracker.Tracker.
        ...
        embedder_wts: Optional[str] = None
            Optional specification of path to embedder's model weights. Will default to looking for weights in `deep_sort_oh/embedder/weights`. If deep_sort_oh is installed as a package and CLIP models is used as embedder, best to provide path.
        polygon: Optional[bool] = False
            Whether detections are polygons (e.g. oriented bounding boxes)
        today: Optional[datetime.date]
            Provide today's date, for naming of tracks. Argument for deep_sort_oh.deep_sort.tracker.Tracker.
        """
        ...
        if embedder is not None:
            ...
            if embedder == "mobilenet":
                from deep_sort_oh.embedder.embedder_pytorch import (
                ...
                from deep_sort_oh.embedder.embedder_pytorch import TorchReID_Embedder as Embedder
                ...
                from deep_sort_oh.embedder.embedder_clip import (
