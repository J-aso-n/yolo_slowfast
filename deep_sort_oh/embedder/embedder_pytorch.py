...
from deep_sort_oh.embedder.mobilenetv2_bottle import MobileNetV2_bottle

logger = logging.getLogger(__name__)

MOBILENETV2_BOTTLENECK_WTS = pkg_resources.resource_filename(
    "deep_sort_oh", "embedder/weights/mobilenetv2_bottleneck_wts.pt"
)

TORCHREID_OSNET_AIN_X1_0_MS_D_C_WTS = pkg_resources.resource_filename(
    "deep_sort_oh", "embedder/weights/osnet_ain_ms_d_c_wtsonly.pth"
)
