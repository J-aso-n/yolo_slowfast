...
class Tracker:
    ...
    def update(self, detections, today=None):
        ...
        for detection_idx in unmatched_detections:  # 新角色
    ...
    def _match(self, detections):
        ...
        matches = matches_a + matches_b  # a:特征匹配成功的目标 b:IoU 匹配成功的目标
        unmatched_tracks = list(set(unmatched_tracks_a + unmatched_tracks_b))  # 未成功匹配
